...
import { ThemeToggle } from "@/components/theme-toggle"; // I will create this component
    ...
    <main className="min-h-screen bg-background text-foreground overflow-x-hidden selection:bg-primary/20">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 glass border-b border-border">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center space-x-2">
            ...
            <h1 className="text-2xl font-bold tracking-tight">FinLearn<span className="text-primary">AI</span></h1>
          </div>
          
          <div className="flex items-center space-x-6">
            <div className="hidden md:flex items-center space-x-6 text-sm font-medium text-muted-foreground">
              <Link href="#features" className="hover:text-foreground transition-colors">Features</Link>
              <Link href="#why" className="hover:text-foreground transition-colors">Why FinLearn</Link>
            </div>
            <ThemeToggle />
            <Link 
              href="/dashboard"
      ...
      <section className="relative pt-40 pb-20 px-6 min-h-[90vh] flex flex-col justify-center items-center text-center">
        ...
        >
          ...
          <span className="text-sm font-medium">FinLearn AI V2.0 is live!</span>
        </motion.div>
      ...
      <section id="features" className="py-32 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">FinLearn AI brings powerful, enterprise-grade financial tools specifically tailored to students.</p>
          </div>
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <h2 className="text-4xl md:text-5xl font-bold leading-tight mb-8">
              Why FinLearn AI <br/> is essential today.
            </h2>
      ...
      <footer className="border-t border-border bg-card py-12 text-center">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between">
          <div className="flex items-center space-x-2 mb-4 md:mb-0">
            ...
            <h1 className="text-lg font-bold tracking-tight">FinLearn<span className="text-primary">AI</span></h1>
          </div>
